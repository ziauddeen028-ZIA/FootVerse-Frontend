              ...
              >
                ...
                {p.goals > 0 && (
                  <span className={`px-1.5 py-0.2 rounded-full text-[10px] ${
                    isSelected ? 'bg-white/25 text-white' : 'bg-green-500/10 text-green-600 dark:text-green-400 font-bold'
                  }`}>
                    ⚽ {p.goals}
                  </span>
                )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="saas-card rounded-2xl p-6 bg-white dark:bg-[#101C14] border border-slate-200/80 dark:border-[#1E3A29] shadow-sm flex items-center justify-between">
                <div>
                  ...
                  <div className="text-3xl sm:text-4xl font-extrabold text-green-600 dark:text-green-400 mt-1">
                    {playerData.overallStats.goals}
                  </div>
                  <p className="text-[11px] text-slate-500 mt-1">Total career goals scored</p>
                </div>
                <div className="w-12 h-12 rounded-2xl bg-green-50 dark:bg-green-950/60 text-green-600 dark:text-green-400 flex items-center justify-center text-xl font-black">
                  ⚽
                </div>
              </div>
              ...
              <div className="saas-card rounded-2xl p-6 bg-white dark:bg-[#101C14] border border-slate-200/80 dark:border-[#1E3A29] shadow-sm flex items-center justify-between">
                <div>
                  ...
                  <div className="text-3xl sm:text-4xl font-extrabold text-teal-600 dark:text-teal-400 mt-1">
                    ...
                    <div
                      ...
                      className={`cursor-pointer rounded-2xl p-5 transition-all duration-200 saas-card border ${
                        isSelected
                          ...
                          : 'bg-white dark:bg-[#101C14] border-slate-200/80 dark:border-[#1E3A29] hover:border-green-400'
                      }`}
                    >
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          <span className="text-[10px] font-bold uppercase tracking-wider text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-950 px-2 py-0.5 rounded-full">
                      ...
                      <div className="mt-4 pt-3 border-t border-slate-100 dark:border-[#1E3A29] flex items-center justify-between text-xs">
                        ...
                        <span className="text-slate-500">
                          Goals: <strong className="text-green-600 dark:text-green-400 font-bold">{entry.tournamentStats.goals}</strong>
                        </span>
                  ...
                  <div className="space-y-2">
                    {activeTournament.matches.map((m) => {
                      ...
                      return (
                        <div
                          key={m.id}
                          className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/70 dark:border-[#1E3A29] hover:border-slate-300 transition gap-3"
                        >
                          <div className="flex items-center space-x-3">
                            {/* Result Badge */}
                            ...
                            <div>
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-[10px] px-2 py-0.5 rounded bg-slate-200 dark:bg-[#101C14] text-slate-600 dark:text-slate-300 font-semibold">
                                  {m.roundName}
                                </span>
                              </div>
