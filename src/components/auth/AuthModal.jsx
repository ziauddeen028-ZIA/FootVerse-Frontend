...
export const AuthModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fade-in">
      <div className="relative w-full max-w-md bg-white dark:bg-[#101C14] rounded-3xl shadow-2xl border border-slate-200 dark:border-[#1E3A29] overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4 flex items-center justify-between border-b border-slate-100 dark:border-[#1E3A29]">
          ...
          <button
            ...
            className="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 rounded-full hover:bg-slate-100 dark:hover:bg-[#16261C] transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`flex flex-col items-center justify-center p-3 rounded-xl border transition ${
                      role === ROLES.PLAYER
                        ? 'border-green-600 bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-400 font-semibold'
                  ...
                  >
                    <Users className="w-5 h-5 mb-1 text-green-600 dark:text-green-400" />
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3 px-4 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-bold text-sm rounded-xl shadow-lg shadow-green-600/30 transition disabled:opacity-50 flex items-center justify-center space-x-2"
          >
            {submitting ? (
