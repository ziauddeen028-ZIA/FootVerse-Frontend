    ...
    <aside className="hidden md:flex flex-col w-64 lg:w-72 bg-white dark:bg-[#101C14] border-r border-slate-200/85 dark:border-[#1E3A29] h-screen sticky top-0 z-30 transition-colors duration-200 flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-1">
        <div className="px-3 pb-2">
          <p className="text-[10px] font-extrabold uppercase tracking-wider text-green-600 dark:text-green-400 flex items-center gap-1.5">
        ...
        {/* Back to Public View */}
        <div className="pt-4 border-t border-slate-100 dark:border-[#1E3A29] mt-4">
          <NavLink
            to="/"
            className="flex items-center space-x-3 px-3.5 py-3 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#16261C] hover:text-slate-900 dark:hover:text-slate-100 transition-all group"
          >
...
export const OrganizerLayout = () => {
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#07130C] text-slate-900 dark:text-slate-100 transition-colors duration-200">
