...
export const GenerateBracketModal = ({
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="w-full max-w-2xl bg-white dark:bg-[#111726] rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200 overflow-hidden">
        
        {/* Header */}
        <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-start justify-between gap-4 shrink-0 bg-slate-50/50 dark:bg-[#0D121F]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="inline-flex items-center space-x-1.5 text-[11px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider mb-0.5">
        ...
        {/* Mode Selector Tabs */}
        <div className="px-6 pt-4 pb-2 shrink-0 bg-white dark:bg-[#111726]">
          <div className="grid grid-cols-2 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 gap-1.5">
            <button
              type="button"
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800 space-y-3 text-xs">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center justify-between">
                  ...
                  <span className="text-blue-600 dark:text-blue-400 font-semibold">{numMatches * 2 - 1} Total Matches</span>
                </h4>
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold transition flex items-center space-x-1"
                    ...
                    <div
                      ...
                      className={`p-3.5 rounded-2xl border transition-all ${
                        isPairComplete
                          ...
                          : 'bg-white dark:bg-[#111726] border-slate-200 dark:border-slate-700'
                      }`}
                    >
        ...
        {/* Footer */}
        <div className="p-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3 bg-slate-50/50 dark:bg-[#0D121F] shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold text-xs hover:bg-slate-100 dark:hover:bg-slate-800 transition"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white font-bold text-xs shadow-md shadow-blue-600/30 transition flex items-center space-x-2"
          >
            {isLoading ? (
