  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center space-x-3 shrink-0">
            <button
              ...
              className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl text-xs shadow-md shadow-indigo-600/20 transition flex items-center space-x-2"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl text-xs shadow-md transition flex items-center space-x-2"
            >
      ...
      {managedTeams.length === 0 && !loading && (
        <div className="saas-card rounded-3xl p-10 sm:p-14 bg-gradient-to-br from-blue-50/60 to-indigo-50/40 dark:from-blue-950/20 dark:to-indigo-950/10 border border-blue-200/60 dark:border-blue-900/40 text-center space-y-6">
          <div className="w-20 h-20 rounded-3xl bg-blue-600/10 dark:bg-blue-500/10 flex items-center justify-center mx-auto shadow-inner">
          ...
          <div className="flex items-center justify-center flex-wrap gap-3 pt-2">
            <button
              ...
              onClick={() => setIsJoinCodeOpen(true)}
              className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl text-xs sm:text-sm shadow-lg shadow-indigo-600/25 transition inline-flex items-center space-x-2"
            >
              <Key className="w-4 h-4" />
              <span>Join with Team Code</span>
            </button>
            <button
              onClick={() => setIsFormOpen(true)}
              className="px-6 py-3 bg-slate-900 hover:bg-slate-800 dark:bg-slate-700 dark:hover:bg-slate-600 text-white font-bold rounded-2xl text-xs sm:text-sm shadow-md transition inline-flex items-center space-x-2"
            >
              <Plus className="w-4 h-4" />
              <span>Create Team</span>
            </button>
                ...
                <div
                  ...
                  className={`p-4 rounded-2xl border transition-all cursor-pointer relative flex flex-col justify-between space-y-3 group ${
                    isSelected
                      ...
                      : 'bg-white dark:bg-[#111726] border-slate-200/80 dark:border-slate-800 hover:border-blue-400 hover:shadow-sm'
                  }`}
                >
      ...
      {teamCode && selectedTeam && (
        <div className="saas-card rounded-3xl p-6 sm:p-8 bg-white dark:bg-[#111726] border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="px-5 py-2.5 rounded-2xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              ...
              <button
                ...
                className={`p-2.5 rounded-2xl border font-bold text-xs transition flex items-center space-x-1.5 ${
                  codeCopied
                    ...
                    : 'bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-950/30 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-300'
                }`}
              >
