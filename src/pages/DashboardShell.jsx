...
export const DashboardShell = () => {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="saas-card rounded-3xl p-6 sm:p-8 bg-slate-900 dark:bg-[#101C14] text-white border border-slate-800 dark:border-[#1E3A29] shadow-xl overflow-hidden relative">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
          
          <div className="space-y-4 max-w-xl">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 text-xs font-semibold">
            ...
            <p className="text-sm text-slate-300 dark:text-slate-400 leading-relaxed font-sans">
              {!isGuest ? (
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <span className="px-3 py-1.5 rounded-xl bg-slate-800/80 dark:bg-[#16261C] border border-slate-700 dark:border-[#1E3A29] text-xs font-medium text-slate-300 flex items-center space-x-2">
              ...
              {isGuest && (
                <button
                  ...
                  className="px-4 py-2 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl text-xs shadow-md shadow-green-600/30 transition flex items-center space-x-1.5"
                >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="saas-card p-5 sm:p-6 rounded-2xl flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-2xl bg-green-50 dark:bg-green-950/60 text-green-600 dark:text-green-400 flex items-center justify-center flex-shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 saas-card p-6 sm:p-7 rounded-3xl space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="px-3 py-1 rounded-xl bg-slate-100 dark:bg-[#16261C] text-slate-700 dark:text-slate-300 font-mono text-xs font-bold border border-slate-200 dark:border-[#1E3A29]">
              Min {liveMatch.minute}
            </span>
          </div>

          {/* Teams & Scoreboard */}
          <div className="py-4 px-6 rounded-2xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29] flex items-center justify-between">
            
            {/* Home Team */}
            <div className="flex flex-col items-center space-y-2 flex-1 text-center">
              <div className="w-14 h-14 rounded-2xl bg-green-600 text-white font-black text-xl flex items-center justify-center shadow-md">
                ST
              </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29]">
        ...
        <div className="saas-card p-6 sm:p-7 rounded-3xl space-y-5 flex flex-col justify-between">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="px-3 py-1 rounded-full bg-green-50 dark:bg-green-950/60 text-green-700 dark:text-green-300 text-xs font-bold">
                Featured Tournament
              </span>
            ...
            <div className="space-y-3 border-t border-slate-100 dark:border-[#1E3A29] pt-4 text-xs">
          ...
          <button 
            ...
            className="w-full py-3 bg-green-600 hover:bg-green-500 text-white font-bold text-xs rounded-xl shadow-md shadow-green-600/20 transition flex items-center justify-center space-x-2"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="saas-card p-6 sm:p-7 rounded-3xl space-y-4">
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-[#1E3A29]">
            <div className="flex items-center space-x-2">
            ...
            <span 
              onClick={() => navigate('/stats?tab=top-scorers')}
              className="text-xs text-green-600 dark:text-green-400 font-semibold cursor-pointer hover:underline"
            >
              View All
            </span>
          </div>
          ...
          <div className="space-y-3">
            {topScorers.map((player) => (
              <div 
                key={player.name}
                className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29] hover:bg-slate-100 dark:hover:bg-[#1E3A29]/60 transition"
              >
        ...
        <div className="saas-card p-6 sm:p-7 rounded-3xl space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="text-slate-400 border-b border-slate-100 dark:border-[#1E3A29] text-[10px] uppercase font-bold">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-[#1E3A29]/60 font-medium">
                {teamRankings.map((team) => (
                  <tr key={team.team} className="hover:bg-slate-50 dark:hover:bg-[#16261C] transition">
                    ...
                    <td className="py-3 text-right font-extrabold text-green-600 dark:text-green-400">{team.pts}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 saas-card p-6 sm:p-7 rounded-3xl space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div 
              onClick={() => navigate('/tournaments')}
              className="p-4 rounded-2xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29] hover:border-green-500/50 cursor-pointer transition text-center space-y-2 group"
            >
              <div className="w-10 h-10 rounded-xl bg-green-100 dark:bg-green-950/60 text-green-600 dark:text-green-400 mx-auto flex items-center justify-center group-hover:scale-110 transition">
            ...
            <div 
              ...
              className="p-4 rounded-2xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29] hover:border-green-500/50 cursor-pointer transition text-center space-y-2 group"
            >
              <div className="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 mx-auto flex items-center justify-center group-hover:scale-110 transition">
            ...
            <div 
              ...
              className="p-4 rounded-2xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29] hover:border-green-500/50 cursor-pointer transition text-center space-y-2 group"
            >
              <div className="w-10 h-10 rounded-xl bg-amber-100 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400 mx-auto flex items-center justify-center group-hover:scale-110 transition">
        ...
        <div className="saas-card p-6 sm:p-7 rounded-3xl space-y-4">
          ...
          <div className="space-y-3">
            {recentMatches.map((m, idx) => (
              <div key={idx} className="p-3 rounded-2xl bg-slate-50 dark:bg-[#16261C] border border-slate-200/60 dark:border-[#1E3A29] text-xs flex items-center justify-between">
                <div>
                ...
                <span className="font-extrabold font-mono text-sm text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/60 px-2.5 py-1 rounded-xl">
