  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex items-center space-x-2 text-xs text-slate-500 dark:text-slate-400 font-medium">
        ...
        <Link to="/teams" className="hover:text-green-600 dark:hover:text-green-400 transition">Teams</Link>
        <ChevronRight className="w-3.5 h-3.5" />
      ...
      <div>
        <Link
          to="/teams"
          className="inline-flex items-center space-x-1.5 px-3.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-[#16261C] dark:hover:bg-[#1E3A29] text-slate-600 dark:text-slate-300 text-xs font-semibold transition"
        >
